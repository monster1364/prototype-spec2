...
const pages = [
  { name: '메인', path: '/gentle-monster/com/main', description: '젠틀몬스터 커머스 메인' },
]

const commonComponents: { name: string; description: string }[] = []

export default function GmComIndexPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b border-gray-200 px-6 py-3">
        <div className="max-w-5xl mx-auto flex items-center gap-2 text-sm">
          ...
          <span className="text-gray-300">/</span>
          <span className="text-gray-900 font-medium">COM</span>
        </div>
      </header>

      <main className="max-w-5xl mx-auto px-6 py-8 space-y-8">
        <div>
          <h1 className="text-xl font-bold text-gray-900">COM</h1>
          <p className="text-sm text-gray-500 mt-1">젠틀몬스터 커머스</p>
        </div>
